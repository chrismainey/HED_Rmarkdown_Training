...
.pull-right[
<img src='Assests/make_new_word_doc.png'>
]
...
+ Text content doesn't matter, just the styles
...
+ Save it, point to it in the YAML
+ The styles will be used in the new Rmarkdown output.
