...
output:
  ...
  html_document:
    ...
    css: styles(Activity_3_complete).css
---
...
<p> You will notice here in the Markdown code that a 'body' tag has been added at the top of the HTML </p>
<p> Tyically, you would 'wrap' it around all of the HTML code, like it is here.  It then affects all HTML </p>


</body> 

<!-- Activity 2 - add in code into your CSS file to change the background & change the body tags -->
